...
pathdat = '/Users/yeojin/Desktop/E_data/EA_raw/EAB_pupil/MRPET/raw/ASC/maintask/';
pathclean = '/Users/yeojin/Desktop/E_data/EB_cleaned/EBB_pupil/MRPET/continuous/';
load('/Users/yeojin/Desktop/E_data/EA_raw/EAB_pupil/MRPET/raw/ASC/pupilids_maintask.mat');
...
for id = 4:length(rangeids)

    % change trigger name
    name = ['re' rangeids{id} '.asc'];
    ...
    save([pathclean name(1:end-4) '_eyedat_cont.mat'],'eyenew','eye','blinksmall','blinkbig');
    keep names n pathclean pathdat id rangeids tasks p TR cutleft cutright fenster smallblinksize
