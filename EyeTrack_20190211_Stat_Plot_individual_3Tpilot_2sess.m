%% Pupillometric data statistics and plotting for 3T pilot, 2-session version : individuals
...
tag = [1 2; 1 0; 1 2; 1 2; 1 2; 1 0; 1 2; 1 2; 1 2; 1 2; 0 2; 1 2; 1 2; 0 2; 1 0; 0 0; 1 2; 1 2; 0 0];
d1m = [1 2; 1 0; 1 0; 1 2; 1 2; 1 0; 1 0; 1 2; 1 2; 1 2; 1 2; 1 2; 1 2; 1 2; 1 2; 1 2; 1 2; 1 2; 1 2]; % 1=immediate 2=delayed
    ...
    for d = 1:2
        ...
        if tag(i1,d) == 0
            ...
            for i = 1:size(plotdat.fb.all,1)
                meandat = nanmean(plotdat.fb.all,2); stddat = nanstd(plotdat.fb.all');
                plotdat_z.fb.all = plotdat.fb.all - repmat(meandat,1,size(plotdat.fb.all,2));
                plotdat_z.fb.all = plotdat.fb.all ./ repmat(stddat',1,size(plotdat.fb.all,2));
            ...
            shadedErrorBar((1:length(time{1,1})),plotdat_preproc.stim.neu,{@nanmean,errorbar},'lineprops',{'b-o','markerfacecolor','b'}); hold on;
